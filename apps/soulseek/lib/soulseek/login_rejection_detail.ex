defmodule Soulseek.LoginRejectionDetail do
  ...
  def to_wire(:nick_leading_or_trailing_space), do: "No leading and trailing spaces allowed in nick."
  ...
  def from_wire("No leading and trailing spaces allowed in nick."), do: :nick_leading_or_trailing_space
end
